...
<div class="flex flex-row w-screen h-16 my-2">
    <Attribute text={items.Name} type="Name" />
    <Attribute text={items.Period} type="Era"/>
    <Attribute text={items.Points} type="Points"/>
    <Attribute text={items.Armor} type="Armor"/>
